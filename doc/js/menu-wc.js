...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">mat-progress-buttons documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/MatProgressButtonsModule.html" data-type="entity-link">MatProgressButtonsModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-MatProgressButtonsModule-e27725271f89b85683c55f427be7b9fb"' :
                                            ...
                                            <li class="link">
                                                <a href="components/MatSpinnerButtonComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MatSpinnerButtonComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/MatProgressButtonIcon.html" data-type="entity-link">MatProgressButtonIcon</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MatProgressButtonOptions.html" data-type="entity-link">MatProgressButtonOptions</a>
                            </li>
                        </ul>
                    </li>
            </ul>
